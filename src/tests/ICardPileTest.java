...
public class ICardPileTest {
	...
	/* el siguiente test debe fallar alrededor de una cada 7 veces, ya que 
	 * revuelve aleatoriamente, por lo que no se asegura que la ultima carta
	 * sea efectivamente diferente respecto a la que había en esa posición
	 * antes de revolver el mazo. 
	 */
	@Test
