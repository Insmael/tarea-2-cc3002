...
public interface ICardPilesManager {
	...
	/**
	 * Returns the number of cards available to be drawn (Deck + Discard - the card
	 * that is played right now)
	 * 
	 ...
	 * 
	 * @param newCard
	 *            card to be put on discard pile.
	 */
