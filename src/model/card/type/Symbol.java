 ...
 */
public enum Symbol {
	ZERO("0"), ONE("1"), TWO("2"), THREE("3"), FOUR("4"), FIVE("5"), SIX("6"), SEVEN("7"), EIGHT("8"), NINE("9"), SKIP(
			"Saltar"), DRAW_TWO("Robar 2"), INVERT(
					"Invertir Dirección"), WILD("Comodín"), WILD_DRAW_FOUR("Comodín + Roba 4"), NONE("Sin Símbolo");
