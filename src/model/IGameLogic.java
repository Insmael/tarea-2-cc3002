...
public interface IGameLogic {
	...
	/**
	 * Prepares the turn to be initiated, changing the actual player, shouting UNO
	 * automatically, assigning cards to players if the Draw Well is not empty
	 * 
	 * @param ctrl
	 ...
	 * 
	 * @param player
	 *            player which is drawing the cards
	 * @param ctrl
	 *            controller used by the game.
	 */
	 ...
	 * 
	 * @param player
	 * @throws NoCardsInDeckOrDiscardPilesError
	 */
